      ...
      <div class="section">
        <div class="main">
          ...
          <div class="authors" :title="$t('note.author')">
            <div class="author">
              <IconAuthor></IconAuthor>{{ props.author === 'anon' ? $t('note.anon') : props.author }}
            </div>
            <div
              v-if="props.modauthors !== null && props.modauthors !== ''"
              class="modifiers"
              :title="$t('note.contributors')"
            >
              <IconModify></IconModify
              >{{ JSON.parse(props.modauthors).join(", ") }}
            </div>
            <div class="time" :title="$t('note.readTime')">
              <IconTime></IconTime>{{ $t("note.read") }}: {{ props.readTime
              }}{{ $t("note.min") }}
            </div>
          </div>
        </div>
        <div class="under">
          <div
            ...
            class="menu"
            :title="$t('note.openMenu')"
          >
            <IconMenuOpen></IconMenuOpen>
          </div>
          <div
            class="comments"
            :title="$t('note.jumpComments')"
            @click="emit('scrollComments')"
          >
    ...
    <div class="right">
      ...
      <div class="details">
        ...
        <div class="bottom">
          ...
          <div
            v-if="props.datemod !== null && props.datemod !== ''"
            :title="$t('note.modified')"
            class="detail"
          >
            <IconModify></IconModify>
